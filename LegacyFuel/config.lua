...
Config.Strings = {
	ExitVehicle = "退出载具以加油",
	EToRefuel = "按 ~g~E ~w~给载具加油",
	JerryCanEmpty = "加油箱耗尽",
	FullTank = "油箱已满",
	PurchaseJerryCan = "按 ~g~E ~w~购买一个油箱，花费 ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "按 ~g~E ~w~取消加油",
	CancelFuelingJerryCan = "按 ~g~E ~w~取消加油",
	NotEnoughCash = "没有足够现金",
	RefillJerryCan = "按 ~g~E ~w~ 重新填满手中油箱",
	NotEnoughCashJerryCan = "没有足够现金，不能填满手中油箱",
	JerryCanFull = "手中油箱已满",
	TotalCost = "花费",
}
